                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url();?>login_controller/category_update">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="<?php echo $_SESSION['x'];?>" name="category" value="<?php echo strtoupper($catName); ?>"/>
...
<script>
    ...
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"<?php echo base_url(); ?>live_search/fetchsubject",
                method:"POST",
                data:{query:query},
